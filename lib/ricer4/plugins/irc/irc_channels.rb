module Ricer4::Plugins::Irc
  class IrcChannels < Ricer4::Plugin
    ...
    def plugin_init
      arm_subscribe('irc/353') do |message|; on_names_list(message); end
      arm_subscribe('irc/join') do |message|; on_user_joined(message); end
      arm_subscribe('irc/part') do |message|; on_user_parted(message); end
    end
