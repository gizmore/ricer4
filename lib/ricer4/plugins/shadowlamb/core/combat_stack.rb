...
#      party.send_message("shadowlamb.msg_encounter", enemies: party.display_members)
    ...
    arm_subscribe('player/after/fighting') do |player, elapsed|
