module Ricer4::Plugins::Poll
  class Question < ActiveRecord::Base
    ...
    belongs_to :creator, :class_name => 'Ricer4::User', :foreign_key => 'user_id'
    has_many :options, :class_name => "Ricer4::Plugins::Poll::Option", :foreign_key => 'question_id'
    has_many :answers, :class_name => "Ricer4::Plugins::Poll::Answer", :through => :options
