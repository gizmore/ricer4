  ...
  def has_usage(pattern='', options={})
    class_eval{|klass|
      ...
      def scope_and_permission_text
        ...
        key = 'ricer3.extender.has_usage.usage_both'
        key = 'ricer3.extender.has_usage.usage_scope' if permission.public?
        key = 'ricer3.extender.has_usage.usage_permission' if scope.everywhere?
